...
<head>
  ...
  <meta charset="utf-8">
  <style>
    body {background: url(http://www.decoraplast.cz/img/096_Kremove_bila.jpg);no-repeat scroll silver center bottom; font-size: 14pt}
h1 {background: grey;Text-Transform: uppercase;font-family:Garamond;text-align:center}
h2 { background: red;font-family:Garamond;font-style:italic;;text-align:center}
.zanr {Text-Transform: uppercase;font-size: 45pt; background: red;text-align:}

.autor {font-size: 15pt;font-style:italic;text-align:right}
.zdroj {font-size: 15pt;font-style:italic;text-align:right}
