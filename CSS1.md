...
<head>
  ...
  <meta charset="utf-8">
  <style> 
body {font-size: 20pt;border-style:dotted}
h1 {color: red; text-decoration: underline; Text-Transform: uppercase;font-family:Garamond;text-align:center}
h2 {font-family:Garamond;font-style:italic;color:blue;text-align:center}
.zanr {Text-Transform: uppercase;font-size: 45pt;color: green;text-align:center}
.autor {font-size: 15pt;font-style:italic;text-align:center}
.zdroj {font-size: 15pt;font-style:italic;text-align:center}
.titulek {font-size: 45pt;text-align:center;border-style:solid;border-color: yellow;
